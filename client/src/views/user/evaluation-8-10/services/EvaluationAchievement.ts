...
export const handleDataForm = (props: Props) => {
  ...
  const dataListNews = dataList.map((v, i) => {
    return {
      ...v,
      titleAdditional:
        filterPersonalForms[i].titleAdditional !== undefined
          ? filterPersonalForms[i].titleAdditional
          : v.titleAdditional,
      achievementStatus:
        filterPersonalForms[i].achievement_status !== undefined
          ? filterPersonalForms[i].achievement_status
          : v.achievementStatus,
      reasonComment:
        filterPersonalForms[i].reasonComment !== undefined ? filterPersonalForms[i].reasonComment : v.reasonComment,
      pointUser: filterPersonalForms[i].pointUser !== undefined ? filterPersonalForms[i].pointUser : v.pointUser,
      pointEvaluator05:
        filterPersonalForms[i].pointEvaluator05 !== undefined
          ? filterPersonalForms[i].pointEvaluator05
          : v.pointEvaluator05,
      pointEvaluator1:
        filterPersonalForms[i].pointEvaluator1 !== undefined
          ? filterPersonalForms[i].pointEvaluator1
          : v.pointEvaluator1,
      pointEvaluator2:
        filterPersonalForms[i].pointEvaluator2 !== undefined
          ? filterPersonalForms[i].pointEvaluator2
          : v.pointEvaluator2,
    };
