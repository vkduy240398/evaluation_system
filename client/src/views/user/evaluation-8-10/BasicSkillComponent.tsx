...
import basicSkillColumn810 from './data/ColumnBasicSkill';
...
const BasicSkillComponent810: FC<Props> = (props) => {
  const totalBasic = {
    itemNo: -1,
    difficulty: '',
    content: '',
  ...
  const { evaluationBasicSkills, isEvaluatorUser, isF5, statusEvaluation, isEvaluationDate, isReview } = props;
  ...
  const columns = basicSkillColumn810({ ...props });
  ...
  return (
    <>
      ...
      <TableCustomComponent
        dataSources={
          (statusEvaluation >= 50 && isEvaluationDate) || statusEvaluation >= 51
            ? [...dataSources, totalBasic]
            : dataSources
        }
        columns={columns}
        size="small"
...
export default BasicSkillComponent810;
