  ...
  if (isDisplayUserEvaluator)
    columns.push({
      ...
      render: (text: any, record: UserEvaluationToProSkillType, index: any) => {
            ...
            <Row align={'middle'}>
              ...
              >
                <Item
                  ...
                  name={`evaluationUser-pro-skill-key${record.key}`}
                  // initialValue={text}
                  rules={[
                    {
        ...
        return (
          <>
            {record.totalPointUser !== null && record.pointUser !== null ? (
  ...
  if (isDisplayEvaluator05)
    columns.push({
      ...
      render: (text: any, record: UserEvaluationToProSkillType, index: any) => {
            ...
            <Row align={'middle'}>
              ...
              >
                <Item
                  ...
                  style={{ textAlign: 'left', margin: 0 }}
                  name={`evaluation05-pro-skill-key${record.key}`}
                  initialValue={text}
                >
                  <Select
                    allowClear
        ...
        return (
          <>
            {record.totalPointEvaluator05 !== null && record.pointEvaluator05 !== null ? (
              <div style={{ display: 'flex' }}>
                <div style={{ flexBasis: '45%', textAlign: 'right' }}>{text || 0}</div>
                <div style={{ flexBasis: '5%', letterSpacing: '1px' }}></div>
                <div style={{ flexBasis: '45%', textAlign: 'left', fontWeight: 600 }}>
  ...
  if (isDisplayEvaluator1)
    columns.push({
      ...
      render: (text: any, record: UserEvaluationToProSkillType, index: any) => {
            ...
            <Row align={'middle'}>
              ...
              >
                <Item
                  ...
                  style={{ textAlign: 'left', margin: 0 }}
                  name={`evaluation10-pro-skill-key${record.key}`}
                  initialValue={text}
                >
                  <Select
                    allowClear
        ...
        return (
          <>
            {record.totalPointEvaluator1 !== null && record.pointEvaluator1 !== null ? (
              <div style={{ display: 'flex' }}>
                <div style={{ flexBasis: '45%', textAlign: 'right' }}>{text || 0}</div>
                <div style={{ flexBasis: '5%', letterSpacing: '1px' }}></div>
                <div style={{ flexBasis: '45%', textAlign: 'left', fontWeight: 600 }}>
  ...
  if (isDisplayEvaluator2)
    columns.push({
      ...
      render: (text: any, record: UserEvaluationToProSkillType, index: any) => {
            ...
            <Row align={'middle'}>
              ...
              >
                <Item
                  ...
                  style={{ textAlign: 'left', margin: 0 }}
                  name={`evaluation20-pro-skill-key${record.key}`}
                  initialValue={text}
                >
                  <Select
                    allowClear
        ...
        return (
          <>
            {record.totalPointEvaluator2 !== null && record.pointEvaluator2 !== null ? (
              <div style={{ display: 'flex' }}>
                <div style={{ flexBasis: '45%', textAlign: 'right' }}>{text || 0}</div>
                <div style={{ flexBasis: '5%', letterSpacing: '1px' }}></div>
                <div style={{ flexBasis: '45%', textAlign: 'left', fontWeight: 600 }}>
...
export default proSkillColumn810;
