            ...
            <Row align={'middle'}>
              ...
              >
                <Item
                  ...
                  name={`pointEvaluatorUser-keyBasic${record.key}`}
                  initialValue={text}
                >
                  <Select
                    allowClear
            ...
            <Row align={'middle'}>
              ...
              >
                <Item
                  ...
                  style={{ textAlign: 'left', margin: 0 }}
                  name={`pointEvaluator05-keyBasic${record.key}`}
                  initialValue={text}
                >
                  <Select
                    allowClear
            ...
            <Row align={'middle'}>
              ...
              >
                <Item
                  ...
                  style={{ textAlign: 'left', margin: 0 }}
                  name={`pointEvaluator1-keyBasic${record.key}`}
                  initialValue={text}
                >
                  <Select
                    allowClear
            ...
            <Row align={'middle'}>
              ...
              >
                <Item
                  ...
                  style={{ textAlign: 'left', margin: 0 }}
                  name={`pointEvaluator2-keyBasic${record.key}`}
                  initialValue={text}
                >
                  <Select
                    allowClear
...
export default basicSkillColumn810;
