...
//  ** Component Imports
import BasicSkillComponent from './BasicSkillComponent';
import BehaviorSkillComponent from './BehaviorSkillComponent';
import { statusEvaluationType } from '../../../common/status';
import AchievementAdditionalComponent from './AchievementAdditionalComponent';
import CommentComponent from './CommentComponent';
import AchievementComponent from './AchievementComponent';
import ProSkillComponent from './ProSkillComponent';
...
const TabEvaluationComponent: FC<Props> = (props) => {
  const {
    proSkillList,
  ...
  const isHiddenButtonEvaluator: boolean = [0, 1, 2, 50, 51, 52].includes(statusEvaluation) && !isEvaluatorUser;
  ...
  const isButtonAddProSkillDisplayIsEvalutenGoals =
    [50, 51, 52].includes(statusEvaluation) && isEvaluatorUser && isEvaluationDate;
  ...
  const isApprovateRejectGoal =
    (isEvaluator05 || isEvaluator10 || isEvaluator20) && !isNotEvaluator2 && !isF5 && !isEvaluatorException;
  ...
  const renderTabs: TabsProps['items'] | any = [
    {
      ...
      children: (
        <ProSkillComponent
          dataSources={proSkillList}
          keyPassProSkill={keyPassProSkill}
          {...evaluatorProps}
          isF5={isF5}
    ...
    },
    {
      ...
      children: (
        <AchievementComponent
          ...
          isF5={isF5}
          openNotification={openNotification}
          isApprovateRejectGoal={isApprovateRejectGoal}
          fullName={fullName}
    ...
    },
    {
      ...
      children: (
        <BasicSkillComponent
          evaluationBasicSkills={evaluationBasicSkills}
          {...evaluatorProps}
          isF5={isF5}
          openNotification={openNotification}
        />
...
export default TabEvaluationComponent;
