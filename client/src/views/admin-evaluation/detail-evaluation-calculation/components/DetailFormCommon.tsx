...
import { getItemTagCommon } from './ItemTabCommon';
...
const DetailFormCommon = (props: Props) => {
  ...
  const LV_ALL_TEXT = t('IDS_LEVEL_ALL');
    ...
    <Form labelAlign="left" labelCol={{ span: 1 }} layout="horizontal" style={{ width: '100%' }} form={props.form}>
      <Card>
        ...
        <Form.Item label={t('IDS_LEVEL')} colon={false} className="ant-form-item-info">
          {props.dataSource?.type === VersionSettingType.LEVEL_ALL ? LV_ALL_TEXT : ''}
        </Form.Item>
      ...
      <div style={{ marginTop: 15 }}>
        <div>
          <Tabs
            ...
            defaultActiveKey={props.currentTab || 'pro'}
...
export default DetailFormCommon;
