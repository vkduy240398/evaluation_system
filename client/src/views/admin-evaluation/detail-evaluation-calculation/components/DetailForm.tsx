...
import { getItemTag } from './ItemTab';
...
const DetailForm = (props: Props) => {
  ...
  const LV_1_7_TEXT = '1 ～ 7';
  const LV_8_10_TEXT = '8 ～ 10';
    ...
    <Form labelAlign="left" labelCol={{ span: 1 }} layout="horizontal" style={{ width: '100%' }} form={props.form}>
      <Card>
        ...
        <Form.Item label={t('IDS_LEVEL')} colon={false} className="ant-form-item-info">
          {props.dataSource?.type === VersionSettingType.LEVEL_1_7 ? LV_1_7_TEXT : ''}
          {props.dataSource?.type === VersionSettingType.LEVEL_8_10 ? LV_8_10_TEXT : ''}
        </Form.Item>
      ...
      <div style={{ marginTop: 15 }}>
        <div>
          <Tabs
            ...
            defaultActiveKey={props.currentTab || 'basic'}
