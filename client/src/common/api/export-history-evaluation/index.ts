...
const exportExcelHistoryEvaluation = async (errorCallBackExport: (bool: boolean) => void, params: any) => {
  // console.log('check params', params);
  const exportTimes = moment(new Date()).format('YYYYMMDDHHmmss');
  errorCallBackExport(true);

  return await HttpAxios.Get('/api/v1/f5/management-evaluation-history/export-history-evaluation', {
    params: params,
  }).then(async (res) => {
...
const exportHistoryEvaluationApiService = {
  exportExcelHistoryEvaluation,
};
export default exportHistoryEvaluationApiService;
