...
import { itemAppoveList } from '../../../../model/Conditions';
import { proSkillPublicStatus, proSkillStatus } from '../../../../common/status';
import { t } from 'i18next';
import { urlCompanyCode } from '../../../../common/util';
interface Props {
  dataState: itemAppoveList[] | undefined;
  isLoading: boolean;
}
const ListApproveProSkillTable: React.FC<Props> = (props: Props) => {
  const columns = [
    {
...
export default ListApproveProSkillTable;
