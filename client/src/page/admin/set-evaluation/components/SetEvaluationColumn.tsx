                ...
                <ProfileOutlined
                  ...
                  onClick={() => {
                    setUserInfor({
                      ...
                      email: record.email,
                      company:
                        record?.childrens?.length > 0 ? record?.childrens[0]?.companyName : record?.company?.name,
                      department:
                        record?.childrens?.length > 0
                          ? record?.childrens[0]?.level > 7
                            ? record?.childrens[0]?.divisionName
                            : record?.childrens[0]?.departmentName
                          : record?.evaluatorDefault?.level > 7
                          ? record?.evaluatorDefault?.divisionName
                          : record?.evaluatorDefault?.departmentName,
                    });
                    setData(record.childrens);
                    setOpenPopUp(true);
                  }}
                />
              ) : (
...
export default SetEvaluationColumn;
