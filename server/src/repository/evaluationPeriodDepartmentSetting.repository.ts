    ...
    const [record] = await this.entity.upsert(
      {
        ...
        companyGroupCode,
        dateCreationGoalDepartmentStart: item.dateCreationGoalDepartmentStart ?? null,
        dateCreationGoalDepartmentEnd: item.dateCreationGoalDepartmentEnd ?? null,
        dateCreationGoalStart: item.dateCreationGoalStart ?? null,
        dateCreationGoalEnd: item.dateCreationGoalEnd ?? null,
        dateEvaluationDepartmentStart: item.dateEvaluationDepartmentStart ?? null,
