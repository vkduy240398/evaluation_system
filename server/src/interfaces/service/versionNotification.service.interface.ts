...
export interface VersionNotificationServiceI {
  ...
  ): Promise<ListVersionNotificationResponse>;

  getDetailNotification(
    versionId: number,
    companyGroupCode?: string,
  ): Promise<VersionNotificationDto>;

  saveDraftVersionNotification(
    versionNotificationDto: VersionNotificationDto,
    type: string,
    req: Request,
  ): Promise<VersionNotificationDto | ErrorMessageResponseDto>;
  ...
  savePublicVersionNotification(
    ...
    VersionDateValidation | ErrorMessageResponseDto | VersionNotificationDto
  >;
  ...
  publicVersionNotification(
    ...
    companyGroupCode: string,
    timeZone: string,
  ): Promise<PublicVersionNotificationDto | VersionDateValidation>;
}
