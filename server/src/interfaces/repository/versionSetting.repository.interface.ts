...
export interface VersionSettingRepositoryI {
  getListVersionSettingPaging(
    param: ListEvaluationCalculationHistoryDto,
    req: Request,
  ): Promise<VersionSetting[]>;

  countListVersionSetting(
    param: ListEvaluationCalculationHistoryDto,
    req: Request,
  ): Promise<number>;

  getVersionSettingById(
