// template 1
export const startGoalSettingPeriodTemplate = () => {
...
// template 1.1
export const startGoalSettingPeriodTemplate1 = () => {
  const content = { title: '', body: '' };
...
// template 1.2
export const startGoalSettingPeriodTemplate2 = () => {
  const content = { title: '', body: '' };
...
// template 2.1
export const startEvaluationPeriodTemplate = () => {
  const content = { title: '', body: '' };
...
// template 2.2
export const startEvaluationPeriodTemplate1 = () => {
  const content = { title: '', body: '' };
...
// template 2.3
export const startEvaluationPeriodTemplate2 = () => {
  const content = { title: '', body: '' };
...
// template 3
export const updateGoalSettingTimeTemplate = () => {
  const content = { title: '', body: '' };
...
// template 3.1
export const updateGoalSettingTimeTemplate1 = () => {
  const content = { title: '', body: '' };
...
// template 3.2
export const updateGoalSettingTimeTemplate2 = () => {
  const content = { title: '', body: '' };
...
// template 4
export const updateEvaluationTimeTemplate = () => {
  const content = { title: '', body: '' };
...
// template 4.1
export const updateEvaluationTimeTemplate1 = () => {
  const content = { title: '', body: '' };
...
// template 4.2
export const updateEvaluationTimeTemplate2 = () => {
  const content = { title: '', body: '' };
...
// template 5
export const sendMailStartExceptionalCase = () => {
  const content = { title: '', body: '' };
...
// template 6
export const sendMailChangeExceptionalCase = () => {
  const content = { title: '', body: '' };
...
// template 7 - lấy data template mail id 11
export const evaluatorApproveGoalSettingTemplate = () => {
  const content = { title: '', body: '' };
...
// template 8 - lấy data template mail id 12
export const submitGoalAndEvaluationTemplate = () => {
  const content = { title: '', body: '' };
...
// template 9 - lấy data template mail id 13
export const evaluatorRejectingTemplate = () => {
  const content = { title: '', body: '' };
...
// template 10
// lấy data template mail id 14
export const adminPublicEvaluationTemplate = () => {
  const content = { title: '', body: '' };
...
// template 11 - lấy data template mail id 15
export const requestingProSkillApprovalTemplate = () => {
  const content = { title: '', body: '' };
...
// template 12.1 - pro skill approver click button approve
// lấy data template mail id 16
export const approveProSkillVersionToAdminTemplate = () => {
  const content = { title: '', body: '' };
...
// template 12.2 - send to Approver other than the specialist skill setter/approved user in the relevant department
// lấy data template mail id 17
export const approveProSkillVersionToOtherTemplate = () => {
  const content = { title: '', body: '' };
...
// template 13
// lấy data template mail id 18
export const rejectProSkillVersionTemplate = () => {
  const content = { title: '', body: '' };
...
// template 14
export const publicBasicSkillTemplate = () => {
  const content = { title: '', body: '' };
...
// template 15
export const publicBehaviorTemplate = () => {
  const content = { title: '', body: '' };
...
// template 16 => ko giu mail khi public pro skill nua
export const publicProSkillTemplate = () => {
  const content = { title: '', body: '' };
...
// lấy data template mail id 2
export const mailNotificateEvaluation = () => {
  const content = { title: '', body: '' };
  ...
  1．URL：<a href="{{loginURL}}">{{loginURL}}</a><br>
...
// lấy data mail template id 1
export const mailNotificateGoalSetting = () => {
  const content = { title: ``, body: `` };
...
export const mailNotificateCronjobFailed = () => {
  const content = { title: ``, body: `` };
