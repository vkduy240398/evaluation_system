import { AchievementAdditionalType, AchievementType, BasicBehaviorType, EvaluationQuery, UserEvaluationAchievementType, UserEvaluationBasicBehaviorType } from '../user.interfaces';
...
export interface UserRepositoryI {
    ...
    getEvaluatorByEvaluationIdAndOrder(id: any, order: any): any;
    ...
    getListUserEvaluationByEvaluationPeriodId(listUserSelected: any, id: any): any;
    ...
    importUserProcedure(year: number, periodIndex: number, userIds: number[], isImport: number, companyGroupCode: string, timeZone: string): any;
    ...
    listToEmail(type: string, year: string, periodIndex: string, companyGroupCode: string, departmentId?: number): Promise<any>;
    ...
    getUserByEmail(email: string, companyGroupCode: string): any;
    getEvaluationPeriod(query: EvaluationQuery, userId: number, companyGroupCode: string): Promise<any[]>;
    getEvaluationById(id: number, userId: number, isEvaluatorUser: boolean): Promise<{
        evaluationDetail: Evaluation;
        evaluationAchievementPersonals: any;
    }>;
    getEvaluationById2(id: number, userId: number, isEvaluatorUser: boolean, companyGroupCode: string | null): Promise<{
    ...
    updateEvaluationProSkill(evaluationId: number, evaluationPro: any[], transaction: Transaction): Promise<any>;
    ...
    getEvaluationPeriodId(companyGroupCode: string, timeZone: string): Promise<any>;
    getListUser(query: any): any;
    deleteListUser(query: any, companyGroupCode: string, timeZone: string): any;
    updateListUser(query: any): any;
    updateUserInfo(query: any, userId: number): any;
    getEvaluationPeriodByEvaluationId(EvaluationId: number): Promise<any>;
    getEvaluator(userId: number, order: string, companyGroupCode: string): any;
    deletePermission(userId: number, isChangeRole2: boolean, isChangeRoleF3: boolean, isChangeRoleF4: boolean, transaction: Transaction): any;
    updatePermission(body: any, transaction: Transaction): any;
    ...
    updateEvaluationBasicOrBehaviorSkill(evaluationId: number, evaluationBasicBehavior: UserEvaluationBasicBehaviorType[], type: BasicBehaviorType, transaction: Transaction): Promise<EvaluationBasicBehavior[]>;
    ...
    getLengthEvaluationPeriod(query: EvaluationQuery, userId: number, companyGroupCode: string): any;
    getDivisionByUserId(userId: number): any;
    getEvaluationDepartmentId(evaluationId: number): any;
    getDepartmentGoalbyEvaluationDepartmentId(evaluationDepartmentId: number): any;
    searchListUserSettingEvaluator(query: any): any;
    searchListUserSettingEvaluator2(query: any): any;
    getListEvaluator(evaluationCreatorId: number | undefined, companyGroupCode: string): any;
    ...
    countsEvaluationPeriod(query: EvaluationQuery, userId: number): any;
    ...
    getEvaluationByIdV2(id: number, userId: any, isEvaluatorUser: boolean, companyGroupCode: string | null): Promise<{
        evaluationDetail: Evaluation;
        evaluationAchievementPersonals: any;
    ...
    listUserTheSameInforWithEvaluator(query: any): any;
    getVersionSrtting(): any;
    getListSkillByDepDivId(id: any): any;
    importSkillUser(query: any): any;
    getAllSkill(companyGroupCode: string): any;
    getAllSkillPublic(companyGroupCode: string): any;
    updateSkillUser(userId: any, evaluationId: any, periodId: any): any;
    getProSkillPublicListInMenu(userId: number, companyGroupCode: string, timeZone: string): Promise<any>;
