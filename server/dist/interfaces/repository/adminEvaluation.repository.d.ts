...
export interface AdminEvaluationRepositoryI {
    ...
    getAchievementDep(versionId: number, type: 1 | 2, typeEvaluation: TypeAchievement): Promise<any>;
    getAchievementAdditional(versionId: number, type: TypeAchievement): Promise<any>;
    ...
    countEvaluationFixed(type: any, periodId: number, companyGroupCode: string): Promise<any>;
    totalEvaluation(id: number, type: string, companyGroupCode: string): Promise<any>;
    checkDatePeriod(id: number): Promise<any>;
    addHistoryFixEvaluation(periodId: number, jsonStr: string, type: number, checkFixed: number): Promise<any>;
    findHistoryFixEvaluation(periodId: number, type: number): Promise<any>;
    updateEvaluationPeriod(checkFixed: number, periodId: number, t: Transaction): Promise<any>;
    ...
    exportHistoryEvaluation(division: string, department: string, userInfo: string, status: number, yearStart: string, yearEnd: string, companyGroupCode?: string): any;
