...
export interface VersionSettingNsServiceI {
    ...
    saveDraftVersionSetting17ns(versionSettingDto: VersionSettingDto, type: string, req: Request): Promise<any>;
    savePublicVersionSetting17ns(versionSettingDto: VersionSettingDto, req: Request): Promise<any>;
