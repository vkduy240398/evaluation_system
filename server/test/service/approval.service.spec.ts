...
describe('ApprovalService', () => {
  ...
  beforeEach(async () => {
    const moduleRef = await Test.createTestingModule({
      ...
      providers: [ApprovalRepository, ApprovalService, ...ENTITY_MODULES],
    }).compile();
  ...
  test('Approval history', async () => {
    ...
    expect(await approvalService.getListApprovalHistory(1, 97)).toMatchObject(
      results,
    );
  });
});
