-- PROCEDURE: public.process_evaluator_delete(bigint, smallint, numeric)

-- DROP PROCEDURE IF EXISTS public.process_evaluator_delete(bigint, smallint, numeric);

CREATE OR REPLACE PROCEDURE public.process_evaluator_delete(
...
BEGIN
    ...
    -- Gọi stored procedure để xóa setting_review_tbl
    CALL delete_setting_review_auto(user_id_input, evaluator_id_input, evaluation_order_input, evaluation_period_id_input, company_group_code_input, evaluation_id_input);
END;
$BODY$;
